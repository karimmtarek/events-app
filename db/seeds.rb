...
event.registrations.create!(
  name: 'Roger Ebert',
  email: 'rebert@gmail.com',
  how_heard: 'Newsletter'
)
event.registrations.create!(
  name: 'Gene',
  email: 'gene_siskel@gmail.com',
  how_heard: 'Newsletter'
)
